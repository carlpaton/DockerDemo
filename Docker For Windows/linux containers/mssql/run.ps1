Try
{
	...
	docker run --detach --name=microsoftsqlserver_codegentool -p 14331:1433  --env="ACCEPT_EULA=Y" --env="SA_PASSWORD=Password123" microsoft/mssql-server-linux:2017-CU13
